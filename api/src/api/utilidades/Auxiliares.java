...
/**
 * Clase de utilidades que contiene algunos métodos auxiliares para el trabajo con {@link Date}, {@link Calendar}, {@link LocalDate} 
 ...
 * 9.--{@link #convertirDateALocalDate(Date)}<br>
 * 10.--{@link #convertirCalendarALocalDate(Calendar)}<br>
 * 11.--{@link #convertirLocalDateADate(LocalDate)}<br>
 * 12.--{@link #convertirCalendarADate(Calendar)}<br>
 * 13.--{@link #convertirLocalDateACalendar(LocalDate)}<br>
 * 14.--{@link #convertirDateACalendar(Date)}<br>
 * 15.--{@link #introducirElementoListadoOrdenado(List, Comparable...)}<br>
 * 
 * @version 05/07/2023
 * @author EduardoProfe
 *
...
public final class Auxiliares {
	 ...
	 * 
	 * @param d {@link Date} a convertir
	 * @return {@link LocalDate} convertido
	 * 
	 * @throws 			IllegalArgumentException Si <b>d</b>==null.
	 */
	public static LocalDate convertirDateALocalDate(Date d) {
		if(d==null)
			throw new IllegalArgumentException();
	...
	/**
	 * Método para convertir de Calendar a LocalDate
	 * 
	 * @param c {@link Calendar} a convertir
	 * @return {@link LocalDate} convertido
	 * 
	 * @throws 			IllegalArgumentException Si <b>c</b>==null.
	 */
	public static LocalDate convertirCalendarALocalDate(Calendar c) {
		if(c==null)
			throw new IllegalArgumentException();
	 ...
	 * 
	 * @param c {@link LocalDate} a convertir
	 * @return {@link Date} convertido
	 * 
	 * @throws 			IllegalArgumentException Si <b>l</b>==null.
	 */
	public static Date convertirLocalDateADate(LocalDate l) {
		if(l==null)
			throw new IllegalArgumentException();
	...
	/**
	 * Método para convertir de Calendar a Date
	 * 
	 * @param c {@link Calendar} a convertir
	 * @return {@link Date} convertido
	 * 
	 * @throws 			IllegalArgumentException Si <b>c</b>==null.
	 */
	public static Date convertirCalendarADate(Calendar c) {
		if(c==null)
			throw new IllegalArgumentException();
	...
	/**
	 * Método para convertir de LocalDate a Calendar
	 * 
	 * @param c {@link LocalDate} a convertir
	 * @return {@link Calendar} convertido
	 * 
	 * @throws 			IllegalArgumentException Si <b>l</b>==null.
	 */
	public static Calendar convertirLocalDateACalendar(LocalDate l) {
		if(l==null)
			throw new IllegalArgumentException();
		
		Calendar c = Calendar.getInstance();
		c.setTime(convertirLocalDateADate(l));
		return c;
	}
	
	/**
	 * Método para convertir de Date a Calendar
	 * 
	 * @param c {@link Date} a convertir
	 * @return {@link Calendar} convertido
	 * 
	 * @throws 			IllegalArgumentException Si <b>d</b>==null.
	 */
	public static Calendar convertirDateACalendar(Date d) {
		if(d==null)
			throw new IllegalArgumentException();
	...
	/**
	 * Metodo que permite introducir en un listado un elemento dado.
	 * @param e El elemento a insertar
	 * @param listado Listado de elementos donde se insertara
	 */
	public static <T extends Comparable<? super T>> void introducirElementoListadoOrdenado(T e, List<T> listado) {
		boolean aux = true;
		ListIterator<T> iter = listado.listIterator();
