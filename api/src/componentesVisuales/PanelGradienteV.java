...
/**
 * Clase que modela un panel con color gradiente en dirección vertical,
 ...
 *
 */
public class PanelGradienteV extends JPanel{
    ...
    public PanelGradienteV(Color inicioGradiente, Color finGradiente) {
