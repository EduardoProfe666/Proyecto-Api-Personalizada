...
/**
 * Clase de utilidades que contiene algunos mï¿½todos auxiliares para el trabajo con {@link Date}
 * y con el carnet de identidad, ademï¿½s de otros. El acceso a sus mï¿½todos es de manera estï¿½tica.
 * 
...
public final class Auxiliares {
	 ...
	 * previamente validado el carnet de identidad para evitar comportamientos extraï¿½os. 
	 * 
	...
	public static Date convertirFechaNacimientoCiDate(String ci) {
		if(ci==null){
			throw new IllegalArgumentException("Ci no vÃ¡lido");
		}
		int siglo = 0;
	...
	/**
	 * 
	 * Mï¿½todo para determinar la edad actual de la persona en dependencia de su fecha de nacimiento.
	 * 
	...
	/**
	 * 
	 * Mï¿½todo para determinar la diferencia en aï¿½os entre dos fechas.
	 * 
	 * @param fechaInicial {@link Date} fecha inicial (menor)
	 * @param fechaFinal {@link Date} fecha final (mayor) 
	 * @return Entero que representa la diferencia en aï¿½os entre ambas fechas pasadas.<br><br>
	 * 
	 * @throws 		IllegalArgumentException Si la <b>fechaInicial</b>==null, o <b>fechaFinal</b>==null, o
	 * <b>fechaInicial</b> es despuï¿½s que la <b>fechaFinal</b>.
	 * 
	 * @author EduardoProfe
	 */
	...
	/**
	 * Mï¿½todo para determinar el sexo de la persona en dependencia de su carnet de identidad.
	 * Debe estar previamente validado el carnet de identidad para evitar comportamientos extraï¿½os. Devuelve
	...
	/**
	 * Mï¿½todo para sumar (o restar) aï¿½os a una fecha dada.
	 * 
	 * @param fecha {@link Date} fecha a incrementar o decrementar.
	 * @param cantAnyos Cantidad de aï¿½os a variar (negativo si se quiere decrementar)
	...
	/**
	 * Mï¿½todo para determinar la cantidad de caracteres que determinarï¿½a un
	 * entero en caso de ser {@link String}.
	 * 
	 * @param i Entero
	 * @return Cantidad de caracteres que determinarï¿½a <b>i</b> si fuese {@link String}.
	 * 
	 * @author EduardoProfe
	 */
	...
	/**
	 * Mï¿½todo para introducir de forma ordenada un elemento (o varios) en una lista. Puede ser empleado
	 * para ordenar en una lista una serie de elementos, aunque no es recomendable su uso por la complejidad
	 * que podrï¿½a alcanzar el algoritmo, en caso de que sean numerosos elementos.
	 * 
	 * @param listado {@link List} con los elementos a comparar y donde se introducirï¿½ el o los elementos pasados por parï¿½metro
